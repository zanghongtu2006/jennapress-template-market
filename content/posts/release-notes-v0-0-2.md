...
bodyBlocks:
  - type: cta-banner
    title: Try JennaPress yourself
    description: A lightweight, static-first Nuxt CMS starter. Category-driven templates, AI-optimized logic, seamless design switching.
    action:
